...
class Inception2(nn.Module):
    def __init__(self, in_planes, n1x1, n3x3red, n3x3, n5x5red, n5x5, pool_planes):
        ...
        self.b3 = nn.Sequential(
            ...
            nn.BatchNorm2d(n5x5red),
            nn.ReLU(True),
            nn.Conv2d(n5x5red, n5x5, kernel_size=3),
            nn.BatchNorm2d(n5x5),
            nn.ReLU(True),
            nn.Conv2d(n5x5, n5x5, kernel_size=3, padding=1),
            nn.BatchNorm2d(n5x5),
...
class GoogLeNet2(nn.Module):
    def __init__(self):
        ...
        self.a3 = Inception2(192,  64,  96, 128, 16, 32, 32)
        self.b3 = Inception2(256, 128, 128, 192, 32, 96, 64)
        ...
        self.e4 = Inception2(528, 256, 160, 320, 32, 128, 128)

        self.a5 = Inception2(832, 256, 160, 320, 32, 128, 128)
        self.b5 = Inception2(832, 384, 192, 384, 48, 128, 128)
